package com.dicoding.azam.submission2_githubuser.receiver
...
class AlarmReceiver : BroadcastReceiver() {
    ...
    private fun sendNotification(context: Context) {
        val intent = context?.packageManager.getLaunchIntentForPackage("com.dicoding.azam.submission2_githubuser")
        ...
        val builder = NotificationCompat.Builder(context, CHANNEL_ID)
            ...
            .setSmallIcon(R.drawable.ic_vector_notifications_github)
            .setContentTitle(context.resources.getString(R.string.github_user))
    ...
    fun setRepeatingAlarm(context: Context, type: String, time: String, message: String) {
        ...
        Toast.makeText(context,
            context.resources.getString(R.string.repeting_alarm_set_up),
    ...
    fun cancelAlarm(context: Context) {
        ...
        Toast.makeText(context,
            context.resources.getString(R.string.repeting_alarm_dibatalkan),
            Toast.LENGTH_SHORT).show()
    }
}